...
japgrd$INLALARW2D <-  japinlalarw2d$summary.fitted.values[, 1]
@
...
spgrd$INLALARW2D <- rglinlalarw2d$summary.fitted.values[,1]
@
...
<<keep.source=TRUE>>=
rlambda <- seq(0.8, 0.99, length.out = 30)
...
attach(bostondf)
#lcarbayes <-  gaussian.lerouxCAR (form2, W = boston.matB,
